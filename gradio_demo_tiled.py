...
# load photoai
config_path = 'options/PhotoAI_tiled.yaml'
...
title_md = """
# **photoai: Practicing Model Scaling for Photo-Realistic Image Restoration**
...
The service is a research preview intended for non-commercial use only, subject to the model [License](https://github.com/Fanghua-Yu/SUPIR) of photoai.
"""


block = gr.Blocks(title='photoai').queue()
with block:
    with gr.Row():
